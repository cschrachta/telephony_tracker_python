...
urlpatterns = [
  ...
  path('delete_service_provider/<int:provider_id>/', views.delete_service_provider, name='delete_service_provider'),
  path('get_service_provider/<int:provider_id>/', views.get_service_provider, name='get_service_provider'),
